...
draw_net(cppn, filename="images/cppn_before")
draw_net(substrate, filename="images/substrate_before")
...
draw_net(cppn, filename="images/cppn_after")
draw_net(substrate, filename="images/substrate_after")