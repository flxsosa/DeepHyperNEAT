...
draw_net(cppn, filename="images/cppn_before_breadth")
draw_net(substrate, filename="images/substrate_before_breadth")
...
draw_net(cppn, filename="images/cppn_after_breadth")
draw_net(substrate, filename="images/substrate_after_breadth")